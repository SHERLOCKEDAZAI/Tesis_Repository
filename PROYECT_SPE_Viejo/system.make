...
# \\vboxsvr\pruebita\SPE\system.mhs
# The software specification of the system is in file :
# \\vboxsvr\pruebita\SPE\system.mss
...
TESTING_SPE_program: $(CYG_TESTING_SPE_OUTPUT) 

$(CYG_TESTING_SPE_OUTPUT) : $(TESTING_SPE_SOURCES) $(TESTING_SPE_HEADERS) $(TESTING_SPE_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testing_spe_compiler.opt
	@mkdir -p $(TESTING_SPE_OUTPUT_DIR) 
	$(TESTING_SPE_CC) $(TESTING_SPE_CC_OPT) $(TESTING_SPE_SOURCES) -o $(CYG_TESTING_SPE_OUTPUT) \
	$(TESTING_SPE_OTHER_CC_FLAGS) $(TESTING_SPE_INCLUDES) $(TESTING_SPE_LIBPATH) \
	$(TESTING_SPE_CFLAGS) $(TESTING_SPE_LFLAGS) 
	$(TESTING_SPE_CC_SIZE) $(CYG_TESTING_SPE_OUTPUT) 
	@echo ""

TESTING_SPE_programclean:
	rm -f $(TESTING_SPE_OUTPUT) 
